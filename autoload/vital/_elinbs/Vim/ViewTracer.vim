...
execute join(['function! vital#_elinbs#Vim#ViewTracer#import() abort', printf("return map({'jump': '', 'winnr': '', 'exists': '', 'find': '', 'trace_tabpage': '', 'tabnr': '', 'trace_window': ''}, \"vital#_elinbs#function('<SNR>%s_' . v:key)\")", s:_SID()), 'endfunction'], "\n")
delfunction s:_SID
" ___vital___
let s:save_cpo = &cpo
set cpo&vim

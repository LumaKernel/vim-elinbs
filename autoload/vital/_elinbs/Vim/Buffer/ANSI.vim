...
execute join(['function! vital#_elinbs#Vim#Buffer#ANSI#import() abort', printf("return map({'_vital_created': '', '_vital_healthcheck': '', 'define_syntax': ''}, \"vital#_elinbs#function('<SNR>%s_' . v:key)\")", s:_SID()), 'endfunction'], "\n")
delfunction s:_SID
" ___vital___

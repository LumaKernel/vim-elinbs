...
execute join(['function! vital#_elinbs#System#Cache#import() abort', printf("return map({'unregister': '', '_vital_depends': '', 'register': '', 'new': '', '_vital_loaded': ''}, \"vital#_elinbs#function('<SNR>%s_' . v:key)\")", s:_SID()), 'endfunction'], "\n")
delfunction s:_SID
" ___vital___
let s:save_cpo = &cpo
set cpo&vim

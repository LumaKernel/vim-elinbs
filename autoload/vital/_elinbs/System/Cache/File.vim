...
execute join(['function! vital#_elinbs#System#Cache#File#import() abort', printf("return map({'_vital_depends': '', 'dump': '', 'hash': '', 'load': '', 'new': '', '_vital_loaded': ''}, \"vital#_elinbs#function('<SNR>%s_' . v:key)\")", s:_SID()), 'endfunction'], "\n")
delfunction s:_SID
" ___vital___
let s:save_cpo = &cpo
set cpo&vim

...
execute join(['function! vital#_elinbs#Options#Sharp#import() abort', printf("return map({'unset': '', 'format': '', 'set': '', 'is_available': '', 'get': '', 'name': ''}, \"vital#_elinbs#function('<SNR>%s_' . v:key)\")", s:_SID()), 'endfunction'], "\n")
delfunction s:_SID
" ___vital___
